      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-purple-900 via-pink-800 to-orange-700 text-white py-20 md:py-28 mb-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center space-y-10 max-w-4xl mx-auto">
            ...
            {/* YouTube — SatsangSevaSumiran & WhatsApp Group */}
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-8">
              <a
                href="https://www.youtube.com/@SatsangSevaSumiran"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-red-600 hover:bg-red-500 text-white font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-red-500/50"
              >
              ...
              <a
                href="https://chat.whatsapp.com/JC9m19jHUraImJjMvor3GL?mode=gi_t"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-green-600 hover:bg-green-500 text-white font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-green-500/50"
              >
